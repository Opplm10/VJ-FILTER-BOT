...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002218371572'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002176478139') # give your force subscribe channel id here else leave it blank
