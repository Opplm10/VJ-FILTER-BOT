...
BOT_TOKEN = environ.get('BOT_TOKEN', "7402568362:AAG5OXSS8b9iyxzbMed5oje6hulK4LpDves")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002180849680').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002190166229) # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://oppolm10:oppolm10@cluster0.6lprvdu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Clustet0collection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Botdessduuss')
